...
public class FormationService implements Iservice<Formation> {
    ...
    public void add(Formation formation) {
        String req = "INSERT INTO `formation`(`typeF`, `img`) VALUES ('" + formation.getTypeF() + "', '" + formation.getImg() + "')";
        try {
    ...
    public void update(Formation formation) {
        String req = "UPDATE `formation` SET `typeF` = '" + formation.getTypeF() + "', `img` = '" + formation.getImg() + "' WHERE `idFormation` = '" + formation.getIdFormation() + "'";
        try {
            Statement st = connection.createStatement();
            st.executeUpdate(req);
